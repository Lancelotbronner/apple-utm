...
actor UTMRemoteServer {
    private static let service = "_utm_server._tcp"
        ...
        await withErrorNotification {
            ...
            listener = Task {
                await withErrorNotification {
                    ...
                    for try await connection in Connection.advertise(on: port, forServiceType: UTMRemoteServer.service, txtRecord: metadata, connectionQueue: connectionQueue, identity: keyManager.identity) {
